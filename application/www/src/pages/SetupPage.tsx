...
function SetupPage() {
  ...
  if (isLoading) {
    return (
      <div className="relative bg-black flex min-h-screen">
      ...
      <div className="relative z-10 flex flex-col gap-6 mx-auto text-center flex items-center justify-center">
        ...
        {!showForm ? (
          <button
            ...
            className="inline-block bg-light hover:bg-active text-white px-4 py-2 rounded-full text-lg font-medium transition-colors"
          >
            Get started
          </button>
        ) : (
          ...
          >
            ...
            <button
              ...
              className="bg-light hover:bg-active text-white px-4 py-2 rounded-full text-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
